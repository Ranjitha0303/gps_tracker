 ...
 * @param sendaddr : point to senddata address
 * @param len : data len to be transfer.
 * @return
 *      - SPI_EC_ERROR    fail
 *      - otherwise 
 */
uint32_t nwy_spi_write(int hd, void *sendaddr, uint32_t len);
 ...
 *
 * @param hd : spi bus handle
 * @param sendaddr : point to write data  address
 * @param len : data len to be transfer.
 * @return
 *      - SPI_EC_ERROR    fail
 *      - otherwise 
 */
uint32_t nwy_spi_read(int hd, void *readaddr, uint32_t len);

/**
 * @brief set cs config
 *
 * @param hd : spi bus handle
 * @param cs : select cs to used
 * @param sel : enable or disable cs
 * @return
 *      - SPI_EC_ERROR    fail
 *      - SPI_EC_SUCCESS    success
 */
...
/**
 * @brief umount spi flash to file system.
 *
 * @param base_path : mount point
 * @return
 *      - SPI_EC_SUCESS success
