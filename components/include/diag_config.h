 ...
 */
#define CONFIG_DIAG_DEFAULT_UART DRV_NAME_UART4

/**
 * diag uart default baud rate
 */
#define CONFIG_DIAG_DEFAULT_UART_BAUD 2000000
 ...
 */
#define CONFIG_DIAG_INBUF_SIZE 0x10040
...
/**
 * diag support enc data used static buffer.
 * solve the issue of not being able to download bluescreen when OOM.
 */
#define CONFIG_DIAG_ENC_BUF_STATIC
