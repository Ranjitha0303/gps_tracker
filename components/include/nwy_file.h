...
typedef enum{
    ...
    NWY_RB_MODE = NWY_RDONLY,
    NWY_WB_MODE = NWY_WRONLY,
    NWY_RB_PLUS_MODE = NWY_RDWR,
    NWY_AB_MODE = NWY_CREAT| NWY_RDWR|NWY_APPEND,
    NWY_WB_PLUS_MODE = NWY_CREAT | NWY_RDWR | NWY_TRUNC,
    NWY_AB_PLUS_MODE = NWY_CREAT | NWY_RDWR | NWY_TRUNC,
}nwy_file_action_e;
