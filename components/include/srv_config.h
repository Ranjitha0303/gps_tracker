 ...
 */
/*Begin: disabled by dsl for AT+EGMR set imei in 20220228 */
/* #undef CONFIG_SRV_SIMLOCK_ENABLE */
/*End: disabled by dsl for AT+EGMR set imei in 20220228 */
 ...
 */
#define CONFIG_POWER_KEY_LP_OFF_SUPPORT on

/**
 * shutdown after power key long press then release
 */
/* #undef CONFIG_POWER_OFF_AFTER_RELEASE */

/**
 * power key long press duration millisecond definition
 */
#define CONFIG_POWER_KEY_LP_DURATION 2500

/**
 * support thermal monitor or not
 */
/* #undef CONFIG_THERMAL_MONITOR_SUPPORT */

/**
 * thermal monitor high temperature threshold
 */
/* #undef CONFIG_THERMAL_TEMPERATURE_HIGH */

/**
 * thermal monitor low temperature threshold
 */
/* #undef CONFIG_THERMAL_TEMPERATURE_LOW */

#define CONFIG_FS_UNET_LOG_ENABLE
