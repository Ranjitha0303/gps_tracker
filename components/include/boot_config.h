 ...
 */
#define CONFIG_NORFDL_IMAGE_SIZE 0x14000
 ...
 */
#define CONFIG_NVBIN_FIXED_SIZE 0x28000

/**
 * FDL1, FDL2 default uart device (8910)
 */
/* #undef CONFIG_FDL_DEFAULT_UART */

/**
 * FDL1, FDL2 default uart baud rate (8910)
 */
/* #undef CONFIG_FDL_UART_BAUD */
 ...
 */
/* #undef CONFIG_BOOT_SMPL_THRESHOLD */
 ...
 */
/* #undef CONFIG_BOOT_UNITY_OUTPUT_UART */

/**
 * bootloader unity unit test uart
 */
/* #undef CONFIG_BOOT_UNITY_UART_NAME */

/**
 * bootloader unity unit test uart baud rate
 */
/* #undef CONFIG_BOOT_UNITY_UART_BAUD */
