 ...
 */
#define CONFIG_ATR_MEM_FREE_LATER_COUNT 40

/**
 * whether to enable CINIT URC output
 */
#define CONFIG_ATR_CINIT_URC_ENABLED
...
*/
#define CONFIG_AT_CMD_SUPPORT

/**
 * whether to support camera AT commands
 */
#define CONFIG_AT_CAMERA_SUPPORT

/**
 * whether to support lcd display
 */
#define CONFIG_AT_CAMERA_PREV_DISPLAY_LCD

/**
 * whether to support camera use test mode
 */
#define CONFIG_AT_CAMERA_TEST_MODE

/**
 * whether to support open backlight
 */
#define CONFIG_AT_BACKLIGHT

/**
 * whether to support not lcd show.
 */
#define CONFIG_AT_CAMERA_PREV_WRITEFILE
 ...
 */
#define CONFIG_AT_AP_CALL_CP_SUPPORT

/**
 * whether support PSM related at command
 */
#define CONFIG_AT_PSM_SUPPORT

/**
 * whether support QSCANF at command
 */
#define CONFIG_AT_QSCANF_SUPPORT

/**
 * whether init USB with small memory
 */
#define CONFIG_AT_USB_REDUCE_MEMORY
...
/* #undef CONFIG_NBIOT_RPM_SUPPORT */

/* #undef CONFIG_AT_CMUX_SUPPORT_UBLOX_CASE */
#define CONFIG_MODEM_LTE_LIB
#endif
