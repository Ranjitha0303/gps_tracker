...
/*Begin: Add by gehongru for receive urc data msg in 20231103*/
typedef void (* nwy_data_recv_cb_t)(int msg);
#define NWY_TCPIP_CFW_GPRS_ACT 857
#define NWY_TCPIP_CFW_GPRS_DEACT 858
/*End: Add by gehongru for receive urc data msg in 20231103*/
...
/*Begin:Add by liucheng for set&get dns server 2023.01.12*/
int nwy_set_dns_server(int index,char *dns);

int nwy_get_dns_server(char *dnsadder);
/*End:Add by liucheng for set&get dns server 2023.01.12*/

/*Begin:Add by liucheng for get data flowcalc 2023.03.02*/
int nwy_data_get_flowcalc_info(nwy_data_flowcalc_info_t* flowcalc_info);
/*End:Add by liucheng for get data flowcalc 2023.03.02*/

/*Begin: Add by gehongru for reset gprs service in 20231103*/
int nwy_data_reset_gprs_service(void);
/*End: Add by gehongru for reset gprs service in 20231103*/
...
#endif
/*Begin: Add by gehongru for receive urc data msg in 20231103*/
int nwy_data_urc_recv_cb(nwy_data_recv_cb_t recv_cb);
/*End: Add by gehongru for receive urc data msg in 20231103*/
