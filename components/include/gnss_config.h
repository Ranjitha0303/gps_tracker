...
/* #undef CONFIG_SUPPORT_GNSS */

/* #undef CONFIG_GPS_CHIP_VER_GREENEYE2 */
/* #undef CONFIG_GPS_CHIP_VER_NONE */

#define CONFIG_GPS_MODE_GPS_BD
/* #undef CONFIG_GPS_MODE_GPS_GLONASS */

/* #undef CONFIG_GPS_TCARD_LOG_SUPPORT */

#define CONFIG_GPS_MINI_LOG_SUPPORT

/* #undef CONFIG_GPS_AGPS_SUPPORT_NONE */
#define CONFIG_GPS_AGPS_SUPPORT_QX
/* #undef CONFIG_GPS_AGPS_SUPPORT_SPRD_AGPS */

#define CONFIG_GPS_TRANS_VIA_SIPC
/* #undef CONFIG_GPS_TRANS_VIA_UART */

/* #undef CONFIG_GPS_SPREAD_ORBIT_SUPPORT */
/* #undef CONFIG_SPREAD_ORBIT_MODE_GPS */
/* #undef CONFIG_SPREAD_ORBIT_PRED_DAYS1 */
