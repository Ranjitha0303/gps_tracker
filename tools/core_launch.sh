...
Linux)
    ...
    prepend_var PATH $PROJECT_ROOT/prebuilts/linux/gcc-arm-none-eabi/gcc-arm-none-eabi-10.2.1/bin
...
*_NT*)
    ...
    prepend_var PATH $PROJECT_ROOT/prebuilts/win32/gcc-arm-none-eabi/gcc-arm-none-eabi-10.2.1/bin
    prepend_var PATH $PROJECT_ROOT/tools
